...
public class BookMedcineDetails extends AppCompatActivity {
    EditText edtname,edaddress,edcontact,edpincode;
    Button btnbooking;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_book_medcine_details);
        ...
        btnbooking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(BookMedcineDetails.this, HomeActivity.class));
            }
        });
