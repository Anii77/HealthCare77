...
public class Database extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(qry2);
        String quy3 = "create table orderplace(username text,fullname text,address text,contactno text,pincode int ,date text,time text,amount real ,otype  text)";
    ...
    public void addOrder(String username, String fullname, String address, String contact, int pincode, String date, String time, float amount, String otype) {
        ...
        cv.put("contactno", contact);  // Corrected the column name to match your table schema
